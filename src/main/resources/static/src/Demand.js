...
class Child extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <div id="chart">
                    <ReactApexChart id = "demand-shart" options={this.state.options} series={this.state.series} type="line" height={350}/>
                </div>
            ...
            <div className='modal demand-modal' id='modal' onClick={this.onClose}>
                <div className='modal-content demand-modal-content' id='modal' onClick={e => e.stopPropagation()}>
                    ...
                    <div className='actions'>
                        ...
                        <Child demands={this.state.demands} good_counts = {this.state.good_counts} dates = {this.state.dates}/>
